...
public:
    ...
    int mapWidth;
    int mapHeight;
	void setFourceClose() {	forceClosing = true;};
	
    void enableAlarm(QMap<QString,double>&  alertRTUs);
	void disableAlarm();
	/*
	void enableAlarmR4(QStringList&  alertRTUs);
	void disableAlarmR4();
	void enableAlarmFault(QStringList&  alertRTUs);
	void disableAlarmFault();
	*/
