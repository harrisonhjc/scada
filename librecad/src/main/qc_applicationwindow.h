...
#define NUM_SENSORTOOLBAR   5
#define NUM_SENSOR          45
#define DOCK_WIDTH          280
class QMdiArea;
class QC_MDIWindow;
...
public:
	QC_ApplicationWindow(QWidget *parent = 0);
    ...
    void setSensorDock(bool);
	void setSvModeView(double colorImage);
	void setGridMode(bool);
	void setSvMode(double color,bool alert, QListWidget*);
	void setEdMode();
	void setSvWindow(SV_Window *sv);
	void setSvWindowActive();
    void startAlert(QMap<QString,double>& rtus);
	void stopAlert();
	/*
	void startAlertR4(QStringList&);
	void stopAlertR4();
	void startAlertFault(QStringList&);
	void stopAlertFault();
	*/
	void activateMapWindow(const QString& mapFile);
	
	
	//
	QString sensorPrefixPath;
	QString sensorSuffixPath;
	QString	alertSmokePath;
	QString alertImageFile;
...
public slots:
	...
	//sensor slot
	void slotPrintMap();
	void slotSensor(int i);
	void slotSetSvMode();
	void slotSetSvAlertMode();
    ...
    */
	...
	void slotFilePrint(QMap<QString,double>& rtuList);
...
public:
	...
	virtual QString getAlertImageFile(){
			return alertImageFile;
	}
    /**
...
private:
   ...
   QDockWidget *sensor2Dock;
   QDockWidget *minimapDock;
   QDockWidget *eventDock;
   QListWidget  *eventList;
    
    void addEventDock(QListWidget*);
    ...
    /** the main toolbars */
	//harrison
	QToolBar* cadPToolBar;
	QToolBar* sensorToolBar[NUM_SENSORTOOLBAR];
	...
	QAction *comSettingAction;
	QAction *comConnectAction;
	QAction *comDisconnectAction;

	QAction* sensorActions[NUM_SENSOR];
