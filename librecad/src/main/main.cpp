...
#endif
    /*
	//multi instances check
	QSharedMemory shared("62d60669-bb94-4a94-88bb-b964890a7e04");
	if(!shared.create( 512, QSharedMemory::ReadWrite) ){
        qDebug() << "Can't start more than one instance of SCADA.";
	    exit(0);
  	}
    */
...
//                }
    ...
    RS_SYSTEM->init(XSTR(QC_APPNAME), XSTR(QC_VERSION), XSTR(QC_APPDIR), prgDir);
        ...
        QString lang = "zh_tw";
        QString langCmd = "zh_tw";
        QString unit = "Millimeter";
/*
...
//        RS_DEBUG->print("main: splashscreen..");
        ...
        QPixmap* pixmap = new QPixmap(":/main/scadasplash.png");
#endif
...
*/
	...
	RS_DEBUG->print("main: ready to create main window:");
	MW_Window* appWin = new MW_Window();
	appWin->setWindowTitle("SCADA");
	/*    
    QC_ApplicationWindow * appWin = new QC_ApplicationWindow();
	//harrison
	//appWin->setWindowTitle(XSTR(QC_APPNAME));
	appWin->setWindowTitle("SCADA");
    appWin->setSvWindowActive();
    */
