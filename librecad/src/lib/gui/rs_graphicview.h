...
public:
  ...
  RS_Vector sizePaper;
	...
	void drawRtuAddress(QString& address,RS_VectorSolutions& sol);
    ...
    virtual void drawLayer2(RS_Painter *painter,double color);
    virtual void drawLayer3(RS_Painter *painter);

	//harrison
	//virtual void drawLayer4(RS_Painter *painter,QStringList&  alertRTUs);
	//virtual void drawLayer5(RS_Painter *painter,QStringList&  alertRTUs);
	//virtual void drawLayer6(RS_Painter *painter,QStringList&  alertRTUs);
    virtual void drawLayer7(RS_Painter *painter, QMap<QString,double>&  alertRTUs);
	virtual void drawLayer8(RS_Painter *painter, QMap<QString,double>&  alertRTUs);
	virtual void drawEntity(RS_Painter *painter, RS_Entity* e, const QString& address);
	virtual void drawEntityPlain(RS_Painter *painter, RS_Entity* e, const QString& address);
	virtual void drawEntityR4(RS_Painter *painter, RS_Entity* e, const QString& address);
	virtual void drawEntityPlainR4(RS_Painter *painter, RS_Entity* e, const QString& address);
	virtual void drawEntityFault(RS_Painter *painter, RS_Entity* e, const QString& address);
	virtual void drawEntityPlainFault(RS_Painter *painter, RS_Entity* e, const QString& address);
	virtual void drawEntityAlert(RS_Painter *painter, RS_Entity* e, const QString& address, double& patternOffset);
	virtual void drawEntityPlainAlert(RS_Painter *painter, RS_Entity* e, const QString& address, double& patternOffset);
