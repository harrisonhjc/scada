...
public:
	...
	void setRtuAddress(QString str){
		data.rtuAddress =  str;
	}
	QString getLocation(){
		return data.location;
	}
	QString getRtuAddress(){
		return data.rtuAddress;
	}
	...
	void drawAlert(RS_Painter* painter, RS_GraphicView* view, const QString& address,double& patternOffset);
	void drawAlarm(RS_Painter* painter, RS_GraphicView* view, const QString& address);
	void drawAlertR4(RS_Painter* painter, RS_GraphicView* view, const QString& address);
	void drawAlertFault(RS_Painter* painter, RS_GraphicView* view, const QString& address);
