...
QAction* RS_ActionEditCopy::createGUIAction(RS2::ActionType type, QObject* parent) {
    ...
    if (type==RS2::ActionEditCopy) {
                ...
                action->setIcon(QIcon::fromTheme("edit-copy", QIcon(":/actions/editcopy.png")));
#else
                action->setIcon(QIcon(":/actions/editcopy.png"));
#endif
...
#if QT_VERSION >= 0x040600
                action->setIcon(QIcon::fromTheme("edit-cut", QIcon(":/actions/editcut.png")));
#else
                action->setIcon(QIcon(":/actions/editcut.png"));
#endif
