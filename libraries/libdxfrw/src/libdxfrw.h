...
public:
     ...
     */
    bool writeRtuImages(DRW_Interface *interface_);
	bool readRtuImages(DRW_Interface *interface_);
	bool processRtuImages();
...
private:
	//harrison
	std::string rtuFileName;
	std::ofstream rtuOFilestream;
